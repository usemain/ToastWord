import {
  Categories,
  CategoriesDictionaryDataMap,
  CategoriesDictionaryMap,
  DictionaryResource
...
const dictionaryMap = {
  '中国考试': chinaExam,
  '国际考试': internationalExam,
  '青少儿英语': childrenEnglish,
  '编程字典': programming,
  '日语词典': japaneseExam,
  '德语词典': germanExam
} as Categories

const categorizedDictionaryMap = {
  '英语': ['中国考试', '国际考试', '青少儿英语'],
  '日语': ['日语词典'],
  '德语': ['德语词典'],
  '编程': ['编程字典']
} as CategoriesDictionaryMap

const categorizedDictionaryDataMap = {
  '英语': [...chinaExam, ...internationalExam, ...childrenEnglish],
  '日语': [...japaneseExam],
  '德语': [...germanExam],
  '编程': [...programming]
} as CategoriesDictionaryDataMap
